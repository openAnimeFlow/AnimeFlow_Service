...
public class SubjectsController {
    ...
    public Result<SubjectsVo> subjectRecommendations(@NotNull @PathVariable int subjectId) {
        return Result.success(ResponseCode.SUCCESS, bangumiService.getRecommendedSubjects(subjectId));
    }
