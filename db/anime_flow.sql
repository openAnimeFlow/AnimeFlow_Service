...
CREATE TABLE `bangumi_character`  (
  ...
  `summary` mediumtext CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL COMMENT '角色简介',
...
CREATE TABLE `bangumi_episode`  (
  ...
  `description` mediumtext CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL COMMENT '章节介绍',
...
CREATE TABLE `bangumi_person`  (
  ...
  `infobox` mediumtext CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL COMMENT '原始 wiki 字符串',
  `summary` mediumtext CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL COMMENT '人物简介',
  `comments` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '评论/吐槽数',
  `collects` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '收藏数',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `bangumi_subject`  (
  ...
  `summary` mediumtext CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL COMMENT '条目简介',
...
CREATE TABLE `bangumi_person_character`  (
  ...
  `summary` mediumtext CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL COMMENT '概要',
